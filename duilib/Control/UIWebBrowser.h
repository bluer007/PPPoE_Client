...
#include <atlcomcli.h>
//-------------古月添加---------------------------------------
#include "../Utils/WebBrowserEventHandler.h"	//古月：修改#include "Utils/WebBrowserEventHandler.h"为#include "../Utils/WebBrowserEventHandler.h"
#include <ExDisp.h>

#include "../Utils/downloadmgr.h"		//古月添加
namespace DuiLib
{
