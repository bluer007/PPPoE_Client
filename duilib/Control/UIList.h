...
public:
	...
	bool CListUI::SelectItemActivate(int iIndex);		//古月：这是根据alberl教程添加的函数，用于保存双击列表确认的项的索引号
protected:
    bool m_bScrollSelect;
	int m_iCurSelActivate;		//古月：这是根据alberl教程添加的变量，用在alberl新添加的函数CListUI::SelectItemActivate中，用于记录双击列表确认的项的索引号
    int m_iCurSel;
    int m_iExpandedItem;
